...
* Working with tables
* Working with layouts, viewports, titleblocks,
  text styles, annotations, and rev clouds
* Working with outputs, page setups, plotting,
  eTransmit, batch plotting, and file formats exporting
